    ...
    <main style={{ minHeight: "100vh", padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <p style={{ margin: 0, color: "#53615a" }}>Define charges, assign them to students, create obligations, then record money received.</p>
        </div>
        <div style={{ marginTop: 20, display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          <Link href={`/app/schools/${schoolId}/finance/payments`} style={{ padding: "10px 14px", borderRadius: 10, background: "#edf2ef", color: "#183c2a", textDecoration: "none", fontWeight: 700 }}>Record payments →</Link>
        </div>
