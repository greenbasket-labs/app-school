...
type Props = { schoolId: string; membershipId: string; recipients: Recipient[]; canSend: boolean };

export default function CommunicationWorkspace({ schoolId, recipients, canSend }: Props) {
